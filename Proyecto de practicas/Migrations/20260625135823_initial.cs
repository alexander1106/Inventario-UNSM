    ...
    public partial class initial : Migration
    {
        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[,]
                {
                    { 1, "Jr. Amorarca N° 334, Morales", true, "Facultad de Ingeniería de Sistemas e Informática", 4 },
                    { 2, "Jr. Amorarca N° 334, Morales", true, "Facultad de Ciencias Económicas", 4 },
                    { 3, "Jr. Amorarca N° 334, Morales", true, "Facultad de Ingeniería Agroindustrial", 4 },
                    { 4, "Jr. Amorarca N° 334, Morales", true, "Facultad de Educación y Humanidades", 4 }
                });
            ...
            migrationBuilder.InsertData(
                table: "Articulos",
                columns: new[] { "Id", "CodigoBarra", "CodigoPatrimonial", "Color", "Condicion", "DepreciacionAnual", "Estado", "FechaAdquision", "Marca", "Medidas", "Modelo", "Nombre", "NroSerie", "TiempoVidaUtil", "TipoArticuloId", "UbicacionId", "ValorActual", "ValorAdquisitivo" },
                values: new object[,]
                {
                    { 1, null, "UNSM-001", "Negro", "Bueno", 20.0, 1, new DateTime(2022, 3, 10, 0, 0, 0, 0, DateTimeKind.Unspecified), "HP", null, "ProDesk 400 G7", "Computadora de Escritorio HP", "SN-HP-001", 5.0, 1, 100, 2000.00m, 2500.0 },
                    { 2, null, "UNSM-002", "Negro", "Bueno", 10.0, 1, new DateTime(2023, 6, 1, 0, 0, 0, 0, DateTimeKind.Unspecified), "Norditalia", null, "Ejecutiva-X", "Silla Ergonómica", null, 10.0, 2, 100, 315.00m, 350.0 }
                });
