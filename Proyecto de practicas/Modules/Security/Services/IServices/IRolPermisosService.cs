...
namespace Proyecto_de_practicas.Modules.Security.Services.IServices
{
    ...
    {
        Task<RolPermisosDTO?> GetAsync(int rolId, int? moduloId, int? subModuloId, int permisoId);
        ...
        Task<bool> DeleteAsync(int rolId, int? moduloId, int? subModuloId, int permisoId);
