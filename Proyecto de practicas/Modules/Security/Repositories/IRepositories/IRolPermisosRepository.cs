...
namespace Proyecto_de_practicas.Modules.Security.Repositories.IRepositories
{
    public interface IRolPermisoRepository
    {
        ...
        Task<RolPermisos?> GetByKeysAsync(int rolId, int? moduloId, int? subModuloId, int permisoId);
        ...
        // 🔥 CORREGIDO
        Task DeleteAsync(int rolId, int? moduloId, int? subModuloId, int permisoId);
